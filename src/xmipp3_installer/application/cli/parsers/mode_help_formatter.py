...
class ModeHelpFormatter(BaseHelpFormatter):
	...
	def format_help(self):
		...
		help_message = self._get_mode_help(mode, general=False) + '\n\n'
		...
		# Adding arg info
		for arg in args:
			help_message += self._text_with_limits('\t' + ', '.join(getParamNames(arg)), arguments.PARAMS[arg][arguments.DESCRIPTION])

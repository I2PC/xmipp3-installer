...
from xmipp3_installer.application.cli.arguments.params import (
  ...
  PARAM_LOGIN, PARAM_MODEL_PATH, PARAM_UPDATE, PARAMS, SHORT_VERSION, LONG_VERSION, PARAM_RUN_FUNCTIONS_TESTS, PARAM_RUN_PROGRAMS_TESTS
)
...
MODE_ARGS = {
  ...
  MODE_CLEAN_BIN: [],
  MODE_CLEAN_ALL: [],
  MODE_TEST: [PARAM_TEST_NAMES, PARAM_SHOW_TESTS, PARAM_RUN_PROGRAMS_TESTS, PARAM_RUN_FUNCTIONS_TESTS],
